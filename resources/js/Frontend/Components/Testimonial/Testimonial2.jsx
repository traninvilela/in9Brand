...
export default function Testimonial2({ testimonial_data }) {
        ...
        <>
            <Div className="cs-shape_wrap_3 cs-parallax">
                <Div
                    className="cs-bg"
                    style={{
                        backgroundImage: `url(${testimonial_data.background_image})`,
                    }}
                >
                    <Spacing lg="130" md="80" />

                    <Div className="cs-shape_3 cs-to_up cs-accent_color">
                        <svg
                            width={162}
                            height={181}
                            viewBox="0 0 162 181"
